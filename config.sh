...
sleep 10
#sudo docker exec -it --user postgres some-postgres bash -c "psql -c 'CREATE TABLE stock_data (symbol text,date date,open int,high int,low int,close int,volume int,adj_close int,month int,year int,day int);'"
